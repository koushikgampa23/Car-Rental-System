...
<input class="form-control" type="text" name="car_number" placeholder=" Enter Car Number" required="">

<button style="background-color: #6db6b9e6;" type="submit" name="submit" class="btn btn- default">Approve
...
$res=mysqli_query($db,"SELECT * FROM `issue_car` ORDER BY username ASC;");
...
echo "<th>"; echo "car_number"; echo "</th>";  echo "</tr>";
...
echo "<td>"; echo $row['car_number']; echo "</td>";
...
mysqli_query($db,"SELECT * 'issue_car' where car_number = '$_POST[car_number]'; ");

?>

<script type="text/javascript"> alert("Approved Successful.");
</script>
